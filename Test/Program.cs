       ...
       //static string Uri = "http://40.118.242.96:12595";
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                //var x = GetReservasModalidadDueño().Result;
                //var x = GetAllMisVehiculos().Result;
                var x = GetFirstVehiculo().Result;
        ...
        static async Task<List<ReservaDTO>> GetReservasModalidadDueño()
        {
            try
            {
                Console.WriteLine("GetAccess");
                ...
                ReservaServiceWebApi reservaServiceWebApi = new ReservaServiceWebApi(webapiaccess);
                Console.WriteLine("Consultando");
                var x = await reservaServiceWebApi.GetReservasModalidadDueño();
                return x;
            }
            catch (Exception ex)
            {
        ...
        static async Task<List<UserInfo>> GetReservasModalidadDueño2()
        {
            try
            {
                Console.WriteLine("GetAccess");
                ...
                ReservaServiceWebApi reservaServiceWebApi = new ReservaServiceWebApi(webapiaccess);
                Console.WriteLine("Consultando");
                var x = await reservaServiceWebApi.GetReservasModalidadDueño2();
                return x;
            }
            catch (Exception ex)
            {
